...
## Technicals
Project has been writen using java and spring boot framework. It uses thymeleaf javascript and css for frontend that is connected with java backend.
